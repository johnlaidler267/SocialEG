...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # configure window
        self.title("Cusomerter co fefmplexfef_exampleff .py")
        ...
        self.logo_label = customtkinter.CTkLabel(
            self.sidebar_frame, text="Instagram", font=customtkinter.CTkFont(size=16, weight="bold"))
        ...
        self.main_button_1.grid(row=3, column=3, padx=(
            20, 20), pady=(20, 21), sticky="nsew")

        # create textbox
        self.textbox = customtkinter.CTkTextbox(self, width=220)
        ...
        self.optionmenu_1 = customtkinter.CTkOptionMenu(self.tabview.tab("CTkTabview"), dynamic_resizing=False,
                                                        values=["Value 9", "Value 3", "Value Long Long Long"])
    ...
    def restart(self):
        self.root.destroy()
        self.root = tk.Tk()
        self.label = tk.Label(self.root, text="Hello, Updated GUI!")
        self.label.pack()
