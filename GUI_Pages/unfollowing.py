...
class Unfollowing(tk.Frame):
    ...
    def init_unfollow_accounts_display(self):
        ...
        total_unfollowed_label = ttk.Label(
            unfollow_accounts_frame,
            text="Total Unfollowed: 1000",
            font=("Helvetica", 15),
        )
        total_unfollowed_label.grid(row=3, column=0, padx=10, pady=(40,20))
    ...
    def goto_Finished(self):
        ...
        self.controller.unfollowing.pack_forget()
